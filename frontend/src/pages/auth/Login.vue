<template>
  <div class="space-y-6">
    <div class="text-center">
      ...
      <p class="text-secondary-500 mt-2">请登录您的账户</p>
    </div>
    ...
    <form @submit.prevent="handleLogin" class="space-y-5">
      ...
      <div class="flex items-center justify-between">
        <Checkbox v-model="form.remember" label="记住我" />
        <router-link to="/forgot-password" class="text-sm text-primary-600 hover:text-primary-700">
          忘记密码？
        </router-link>
      </div>

      <Alert v-if="loginError" variant="danger" :message="loginError" />
    ...
    <div class="relative">
      ...
      <div class="relative flex justify-center text-sm">
        <span class="px-4 bg-white text-secondary-500">或</span>
      </div>
    </div>

    <div class="grid grid-cols-2 gap-3">
      <Button variant="outline" @click="handleOAuthLogin('github')">
      ...
      <Button variant="outline" @click="handleOAuthLogin('google')">
